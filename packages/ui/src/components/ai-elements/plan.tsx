...
export const PlanTrigger = ({ className, ...props }: PlanTriggerProps) => (
  // The remaining props stay on the trigger rather than being spread onto the
  // Button: they are typed against the trigger's own state, and Base UI merges
  // them into the render target for us.
  <CollapsibleTrigger
    render={
      <Button
