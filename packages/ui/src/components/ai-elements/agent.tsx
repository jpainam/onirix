...
import {
  ...
  AccordionItem,
  AccordionTrigger,
} from "@onirix/ui/components/accordion";
    ...
    return (
      ...
      >
        <AccordionTrigger className="px-3 py-2 text-sm hover:no-underline">
          {/* A tool description can be a function of the call context in AI SDK
              v7, which has nothing to render until the tool is actually run. */}
