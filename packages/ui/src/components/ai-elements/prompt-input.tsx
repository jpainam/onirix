...
/**
 * Event types taken from the components themselves rather than written out by
 * hand: this project's UI is built on Base UI, which hands handlers its own
 * event wrapper where Radix passes the bare DOM event.
 */
